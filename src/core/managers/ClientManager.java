...
public class ClientManager implements ClientContext {
    ...
    private void fillCommandFactoryPool()
    {
        ...
        factoryPool.put("save",new SaveCommandFactory(this,serverManager));
        factoryPool.put("read",new ReadCommandFactory(this,serverManager));
        ...
        factoryPool.put("exit_with_save",new ExitWithSaveCommandFactory(this,serverManager));
